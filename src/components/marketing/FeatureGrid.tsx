...
import { Shield, Scale, Clock, Lock, Cpu, ArrowLeftRight, Repeat, Coins } from "lucide-react";

export function FeatureGrid() {
  const features = [
    {
      title: "Multi-Currency Atomic Swaps",
      description:
        "Instant cross-asset internal trading between 8 major cryptocurrencies (CC, BTC, ETH, SOL, BNB, LTC, XRP, DOGE) with zero slippage and atomic dual-leg ledger settlement.",
      icon: ArrowLeftRight,
    ...
    },
    {
      ...
      description:
        "Predictable, ultra-low per-asset network gas fee structure with dynamic routing into protocol treasury pools.",
      icon: Coins,
    ...
    },
    {
      ...
      description:
        "Format addresses (CC0x..., BTC0x..., ETH0x...) verified with SHA-256 mixed-case checksums to guarantee zero transfer typos.",
      icon: Lock,
    ...
    <section id="features" className="py-24 relative">
      <div className="text-center max-w-3xl mx-auto mb-16">
        ...
        <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-white tracking-tight">
          Engineered for Institutional Rigor & Multi-Asset Velocity
        </h2>
        <p className="mt-4 text-base sm:text-lg text-slate-400">
          The Coin Caret blockchain engine fuses bank-grade accounting precision with next-generation Web3 multi-currency trading.
        </p>
      </div>
