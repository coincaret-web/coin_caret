...
import { Settings, History, ShieldAlert } from "lucide-react";
...
export default async function AdminSettingsPage() {
  const [rateData, auditLogs] = await Promise.all([
    getCcUsdRate(),
        ...
        <div className="flex items-center space-x-3 mb-2">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400 font-mono">
              Authoritative exchange rate feeds and institutional parameters
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-1 bg-slate-900/40 border border-slate-800 rounded-2xl p-6 space-y-4">
          <div className="flex items-center space-x-2 border-b border-slate-800/80 pb-3">
            ...
            <h3 className="text-sm font-semibold text-white">Valuation History</h3>
          </div>
